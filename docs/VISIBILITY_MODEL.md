...
- **App permissions scope.** Level 3 says apps get access. *What* access (events only? pose data? raw frames?) is the access tier system from the perception stream design.
