...
// Import ONNX runtime dynamically to avoid bundle issues
...
async function loadONNXRuntime() {
  if (!onnxRuntime) {
    try {
      ...
      console.warn('ONNX Runtime not available, falling back to simplified processing');
      return null;
    }
  }
  return onnxRuntime;
